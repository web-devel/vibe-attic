...
The game uses **HTML, CSS, and JavaScript**, with a canvas for drawing. The planned workshop setup is an M1 MacBook with Pi, started through Ollama, and the locally running `qwen3.6:27b` model. The lesson explains the roles of the model, runtime, harness, generated code, and browser without focusing on product names.
